...
| `pendencias-e-decisoes.md` | **Registro central** | O que está aberto e o que já foi decidido. Consultar ANTES de abrir tarefa nova, e atualizar ao fechar ou abrir pendência — não basta mexer no arquivo em que ela mora |
...
- **Estrutura por tópico do sumário (decisão local — substitui o nome `aula-NN` do Q2):**
  ...
  oficial (`_docs/18. FIS-2.pdf`), tópico com zero à esquerda (`1-01`, `4-16`). O comentário
  no topo de cada arquivo lista os objetivos (OE) do tópico, copiados de `_docs/FIS_2_RA.md` —
